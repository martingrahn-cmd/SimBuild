#!/usr/bin/env node
// R9p: verify road-driven zoning journals and bidirectional zoning/building ownership.
...
const root=process.env.OUT_DIR||'shots/democity/r9p-zoning-building-lifecycle';fs.mkdirSync(root,{recursive:true});
...
const result={method:'fresh current-product worlds; rejected R9o alley is a disposable public transaction fixture for zoning/building lifecycle verification, not an authored route candidate',candidate:{key:'1,0:v',endpoints,type:'alley',productAdoption:false},source:{path:sourcePath,sha256:sha(source)},runs:[],comparisons:[],errors:[],pass:false};
